...
func PNMAddMultiformatAddress(builder *flatbuffers.Builder, multiformatAddress flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(0, flatbuffers.UOffsetT(multiformatAddress), 0)
}
func PNMAddPublishTimestamp(builder *flatbuffers.Builder, publishTimestamp flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(1, flatbuffers.UOffsetT(publishTimestamp), 0)
}
...
func PNMAddFileName(builder *flatbuffers.Builder, fileName flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(3, flatbuffers.UOffsetT(fileName), 0)
}
func PNMAddFileId(builder *flatbuffers.Builder, fileId flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(4, flatbuffers.UOffsetT(fileId), 0)
}
...
func PNMAddTimestampSignature(builder *flatbuffers.Builder, timestampSignature flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(6, flatbuffers.UOffsetT(timestampSignature), 0)
}
func PNMAddSignatureType(builder *flatbuffers.Builder, signatureType flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(7, flatbuffers.UOffsetT(signatureType), 0)
}
func PNMAddTimestampSignatureType(builder *flatbuffers.Builder, timestampSignatureType flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(8, flatbuffers.UOffsetT(timestampSignatureType), 0)
}

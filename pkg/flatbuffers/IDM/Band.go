...
func BandAddFrequencyRange(builder *flatbuffers.Builder, frequencyRange flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(1, flatbuffers.UOffsetT(frequencyRange), 0)
}

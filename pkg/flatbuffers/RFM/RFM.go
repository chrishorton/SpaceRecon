...
func (rcv *RFM) ReferenceFrame() RefFrame {
...
func (rcv *RFM) MutateReferenceFrame(n RefFrame) bool {
...
func RFMAddReferenceFrame(builder *flatbuffers.Builder, referenceFrame RefFrame) {
	builder.PrependInt8Slot(0, int8(referenceFrame), 0)
}
